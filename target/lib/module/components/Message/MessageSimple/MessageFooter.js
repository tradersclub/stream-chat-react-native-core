...
var MessageFooterWithContext = function MessageFooterWithContext(props) {
  ...
  if (isDeleted) {
    return (0, _jsxRuntime.jsxs)(_reactNative.View, {
      ...
      children: [deletedMessagesVisibilityType === 'sender' && (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
  ...
  return (0, _jsxRuntime.jsxs)(_reactNative.View, {
    ...
    children: [otherAttachments.length && otherAttachments[0].actions ? (0, _jsxRuntime.jsxs)(_jsxRuntime.Fragment, {
      children: [(0, _jsxRuntime.jsx)(_icons.Eye, Object.assign({
        pathFill: grey_dark
      }, eyeIcon)), (0, _jsxRuntime.jsx)(_reactNative.Text, {
        style: [{
    ...
    }) : null, showMessageStatus && (0, _jsxRuntime.jsx)(MessageStatus, {}), (0, _jsxRuntime.jsx)(_reactNative.Text, {
      style: [{
        color: grey,
        textAlign: alignment
      }, metaText],
